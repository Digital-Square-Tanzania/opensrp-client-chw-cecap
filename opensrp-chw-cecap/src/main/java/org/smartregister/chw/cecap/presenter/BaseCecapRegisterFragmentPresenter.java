...
public class BaseCecapRegisterFragmentPresenter implements CecapRegisterFragmentContract.Presenter {

    protected WeakReference<CecapRegisterFragmentContract.View> viewReference;
    ...
    public BaseCecapRegisterFragmentPresenter(CecapRegisterFragmentContract.View view, CecapRegisterFragmentContract.Model model, String viewConfigurationIdentifier) {
    ...
    protected CecapRegisterFragmentContract.View getView() {
