...
public class CecapRegisterProvider implements RecyclerViewProvider<CecapRegisterProvider.RegisterViewHolder> {
    ...
    public CecapRegisterProvider(Context context, View.OnClickListener paginationClickListener, View.OnClickListener onClickListener, Set visibleColumns) {
    ...
    private String updateMemberGender(CommonPersonObjectClient commonPersonObjectClient) {
        ...
        return CecapUtil.getGenderTranslated(context, gender);
    ...
    private void populatePatientColumn(CommonPersonObjectClient pc, final RegisterViewHolder viewHolder) {
        try {
            ...
            viewHolder.patientColumn.setTag(R.id.VIEW_ID, BaseCecapRegisterFragment.CLICK_VIEW_NORMAL);

            viewHolder.dueButton.setTag(pc);
            viewHolder.dueButton.setTag(R.id.VIEW_ID, BaseCecapRegisterFragment.FOLLOW_UP_VISIT);
...
//        implement
    ...
    public RegisterViewHolder createViewHolder(ViewGroup parent) {
        View view = inflater.inflate(R.layout.cecap_register_list_row, parent, false);
