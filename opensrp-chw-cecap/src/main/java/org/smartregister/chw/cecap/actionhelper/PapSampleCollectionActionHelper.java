 ...
 */
public class PapSampleCollectionActionHelper extends CecapVisitActionHelper {
    protected Context context;
    protected MemberObject memberObject;
    protected String canTheFacilityPerformPapSmear;

    public PapSampleCollectionActionHelper(Context context, MemberObject memberObject) {
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            canTheFacilityPerformPapSmear = JsonFormUtils.getValue(jsonObject, "can_the_facility_perform_pap_smear");
        } catch (Exception e) {
            Timber.e(e);
        }
    }
    ...
    public BaseCecapVisitAction.Status evaluateStatusOnPayload() {
        if (StringUtils.isNotBlank(canTheFacilityPerformPapSmear)) {
