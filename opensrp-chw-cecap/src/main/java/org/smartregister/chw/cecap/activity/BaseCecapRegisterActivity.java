...
import org.smartregister.chw.cecap.interactor.BaseCecapRegisterInteractor;
import org.smartregister.chw.cecap.listener.CecapBottomNavigationListener;
import org.smartregister.chw.cecap.presenter.BaseCecapRegisterPresenter;
import org.smartregister.chw.cecap.R;
import org.smartregister.chw.cecap.model.BaseCecapRegisterModel;
...
public class BaseCecapRegisterActivity extends BaseRegisterActivity implements CecapRegisterContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FORM_NAME = getIntent().getStringExtra(Constants.ACTIVITY_PAYLOAD.CECAP_FORM_NAME);
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof BaseCecapRegisterFragment) {
    ...
    public void startFormActivity(JSONObject jsonForm) {
        Intent intent = new Intent(this, BaseCecapRegisterActivity.class);
    ...
    public List<String> getViewIdentifiers() {
        return Arrays.asList(Constants.CONFIGURATION.CECAP_REGISTRATION_CONFIGURATION);
    }
    ...
    protected void registerBottomNavigation() {
        ...
        if (bottomNavigationView != null) {
            ...
            BottomNavigationListener familyBottomNavigationListener = new CecapBottomNavigationListener(this);
    ...
    protected void initializePresenter() {
        presenter = new BaseCecapRegisterPresenter(this, new BaseCecapRegisterModel(), new BaseCecapRegisterInteractor());
    }
    ...
    @Override
    public CecapRegisterContract.Presenter presenter() {
        return (CecapRegisterContract.Presenter) presenter;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK && requestCode == Constants.REQUEST_CODE_GET_JSON) {
            ...
            try {
                ...
                JSONArray fieldsOne = CecapJsonFormUtils.fields(form, Constants.STEP_ONE);
    ...
    public void startClientProcessing() {
        try {
            ...
            CecapUtil.getClientProcessorForJava().processClient(CecapUtil.getSyncHelper().getEvents(lastSyncDate, BaseRepository.TYPE_Unprocessed));
