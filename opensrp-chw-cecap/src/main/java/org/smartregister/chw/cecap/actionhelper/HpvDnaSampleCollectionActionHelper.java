 ...
 */
public class HpvDnaSampleCollectionActionHelper extends CecapVisitActionHelper {
    protected Context context;
    protected MemberObject memberObject;
    protected String wasDnaSpecimenCollected;

    public HpvDnaSampleCollectionActionHelper(Context context, MemberObject memberObject) {
    ...
    public void onPayloadReceived(String jsonPayload) {
        try {
            ...
            wasDnaSpecimenCollected = JsonFormUtils.getValue(jsonObject, "was_dna_specimen_collected");
        } catch (Exception e) {
            Timber.e(e);
        }
    }
    ...
    public BaseCecapVisitAction.Status evaluateStatusOnPayload() {
        if (StringUtils.isNotBlank(wasDnaSpecimenCollected)) {
