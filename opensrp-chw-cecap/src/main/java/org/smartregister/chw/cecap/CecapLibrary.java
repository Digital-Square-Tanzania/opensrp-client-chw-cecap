package org.smartregister.chw.cecap;
...
public class CecapLibrary {
    private static CecapLibrary instance;
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new CecapLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static CecapLibrary getInstance() {
        if (instance == null) {
    ...
    private CecapLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
