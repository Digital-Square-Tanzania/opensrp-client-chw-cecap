...
import org.smartregister.chw.cecap.fragment.BaseHomeVisitFragment;
 ...
 */
public class BaseCecapVisitAction {
    ...
    private CecapVisitActionHelper cecapVisitActionHelper;
    private final Map<String, List<VisitDetail>> details;
    private final Context context;
    private final Validator validator;

    private BaseCecapVisitAction(Builder builder) throws ValidationException {
        ...
        this.cecapVisitActionHelper = builder.cecapVisitActionHelper;
    ...
    private void initialize() {
        try {
            ...
            if (cecapVisitActionHelper != null) {
                cecapVisitActionHelper.onJsonFormLoaded(jsonPayload, context, details);
                String pre_processed = cecapVisitActionHelper.getPreProcessed();
                ...
                String sub_title = cecapVisitActionHelper.getPreProcessedSubTitle();
                if (StringUtils.isNotBlank(sub_title)) {
                    this.subTitle = sub_title;
                }

                ScheduleStatus status = cecapVisitActionHelper.getPreProcessedStatus();
                if (status != null) {
    ...
    private void onPayloadReceivedNotifyHelper(String jsonPayload) {
        ...
        cecapVisitActionHelper.onPayloadReceived(jsonPayload);

        String sub_title = cecapVisitActionHelper.evaluateSubTitle();
        if (sub_title != null) {
            setSubTitle(sub_title);
        }

        String post_process = cecapVisitActionHelper.postProcess(jsonPayload);
        if (post_process != null) {
            this.jsonPayload = cecapVisitActionHelper.postProcess(jsonPayload);
        }

        cecapVisitActionHelper.onPayloadReceived(this);
    }
    ...
    public CecapVisitActionHelper getCecapVisitActionHelper() {
        return cecapVisitActionHelper;
    }

    public void setCecapVisitActionHelper(CecapVisitActionHelper cecapVisitActionHelper) {
        this.cecapVisitActionHelper = cecapVisitActionHelper;
    }
    ...
    public void evaluateStatus() {
        ...
        if (getCecapVisitActionHelper() != null) {
            setActionStatus(getCecapVisitActionHelper().evaluateStatusOnPayload());
        }
    }

    public BaseCecapVisitAction.Status computedStatus() {
    ...
    public interface CecapVisitActionHelper {
         ...
         */
        void onPayloadReceived(BaseCecapVisitAction baseCecapVisitAction);
    }
    ...
    public static class Builder {
        ...
        public Builder withHelper(CecapVisitActionHelper cecapVisitActionHelper) {
            this.cecapVisitActionHelper = cecapVisitActionHelper;
            return this;
        }
        ...
        public BaseCecapVisitAction build() throws ValidationException {
            return new BaseCecapVisitAction(this);
        }
    }
