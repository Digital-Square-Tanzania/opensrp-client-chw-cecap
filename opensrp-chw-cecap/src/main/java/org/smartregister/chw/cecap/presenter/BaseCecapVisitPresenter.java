...
public class BaseCecapVisitPresenter implements BaseCecapVisitContract.Presenter, BaseCecapVisitContract.InteractorCallBack {

    protected WeakReference<BaseCecapVisitContract.View> view;
    protected BaseCecapVisitContract.Interactor interactor;
    protected MemberObject memberObject;

    public BaseCecapVisitPresenter(MemberObject memberObject, BaseCecapVisitContract.View view, BaseCecapVisitContract.Interactor interactor) {
    ...
    @Override
    public void preloadActions(LinkedHashMap<String, BaseCecapVisitAction> map) {
        if (view.get() != null)
