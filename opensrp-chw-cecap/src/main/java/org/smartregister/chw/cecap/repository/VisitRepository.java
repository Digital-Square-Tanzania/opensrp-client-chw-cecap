package org.smartregister.chw.cecap.repository;
...
public class VisitRepository extends BaseRepository {
    ...
    public void setNotVisitingDate(String date, String baseID) {
        try {
            ...
            getWritableDatabase().update(Constants.TABLES.CECAP_REGISTER, values, DBConstants.KEY.BASE_ENTITY_ID + " = ?", new String[]{baseID});
        } catch (Exception e) {
            Timber.e(e);
        }
    }
    ...
    public String getLastInteractedWithAndVisitNotDone(String baseEntityID, String dateColumn) {
        ...
        try {
            ...
            cursor = database.query(Constants.TABLES.CECAP_REGISTER, new String[]{dateColumn}, BASE_ENTITY_ID + " = ? " + COLLATE_NOCASE, new String[]{baseEntityID}, null, null, null);
