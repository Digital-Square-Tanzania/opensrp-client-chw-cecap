...
import org.smartregister.chw.cecap.provider.CecapRegisterProvider;
...
public class BaseCecapRegisterFragment extends BaseRegisterFragment implements CecapRegisterFragmentContract.View {
    public static final String CLICK_VIEW_NORMAL = "click_view_normal";
    public static final String FOLLOW_UP_VISIT = "follow_up_visit";

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        CecapRegisterProvider cecapRegisterProvider = new CecapRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
        clientAdapter = new RecyclerViewPaginatedAdapter(null, cecapRegisterProvider, context().commonrepository(this.tablename));
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            ...
            titleView.setText(getString(R.string.cecap));
            titleView.setFontVariant(FontVariant.REGULAR);
        }
    }

    @Override
    public CecapRegisterFragmentContract.Presenter presenter() {
        return (CecapRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseCecapRegisterFragmentPresenter(this, new BaseCecapRegisterFragmentModel(), null);
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BaseCecapProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
