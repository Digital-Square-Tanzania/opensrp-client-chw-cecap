...
public class CecapRegisterProviderTest {
    @Mock
    public CommonPersonObjectClient commonPersonObjectClient;
    @Mock
    public View.OnClickListener listener;
    @Mock
    public CecapRegisterProvider.RegisterViewHolder viewHolder;
    @Mock
    private CecapRegisterProvider testRegisterProvider;
    ...
    public void updateMemberGender() throws Exception {
        ...
        CecapRegisterProvider provider = new CecapRegisterProvider(activity, listener, listener, null);
