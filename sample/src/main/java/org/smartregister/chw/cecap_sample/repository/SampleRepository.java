package org.smartregister.chw.cecap_sample.repository;
...
public class SampleRepository extends Repository {
    ...
    public void onCreate(SQLiteDatabase database) {
        ...
        CecapLibrary.getInstance().visitRepository().createTable(database);
        CecapLibrary.getInstance().visitDetailsRepository().createTable(database);
